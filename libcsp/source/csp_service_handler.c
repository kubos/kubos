...
static int do_cmp_peek(struct csp_cmp_message *cmp) {
	...
	csp_cmp_memcpy_fnc((csp_memptr_t) cmp->peek.data, (csp_memptr_t) (uintptr_t) cmp->peek.addr, cmp->peek.len);
...
static int do_cmp_poke(struct csp_cmp_message *cmp) {
	...
	csp_cmp_memcpy_fnc((csp_memptr_t) (uintptr_t) cmp->poke.addr, (csp_memptr_t) cmp->poke.data, cmp->poke.len);
