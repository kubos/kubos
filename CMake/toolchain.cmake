...
if(TARGET_STM32F4_DISCO_GCC_TOOLCHAIN_INCLUDED)
    return()
endif()
set(TARGET_STM32F4_DISCO_GCC_TOOLCHAIN_INCLUDED 1)
...
#
add_definitions("-DTARGET_STM32F4_DISCO -DTARGET_STM32F407VG -DSTM32F407xx -DTARGET_STM32F4 -DTOOLCHAIN_GCC -DTOOLCHAIN_GCC_ARM")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} ${_CPU_COMPILATION_OPTIONS} -T\"${CMAKE_CURRENT_LIST_DIR}/../ld/STM32F407VG.ld\"")
