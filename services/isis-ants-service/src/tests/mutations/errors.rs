...
fn mutation_errors_multiple() {
    ...
    let expected = json!({
            "errors": ["watchdog_kick (services/isis-ants-service/src/model.rs:355): Configuration error", "watchdog_kick (services/isis-ants-service/src/model.rs:351): Configuration error"]
    });
