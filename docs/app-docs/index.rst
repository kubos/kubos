...
Additionally, :doc:`mission applications <app-guide>` can be easily configured to execute different logic depending on whether they
are run during deployment, during system startup, or on demand.
