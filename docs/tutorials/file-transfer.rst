...
on. By default, this is port 8070.
...
Our transfer command should look like this::
    ...
    $ kubos-file-client -r 10.0.2.20 -p 8070 -P 8081 upload /home/vagrant/my-app/my-mission-app.py /home/kubos/my-mission-app.py
    
Or, from your local dev environment::

    $ cargo run -- -r 10.0.2.20 -p 8070 -P 8081 upload /home/vagrant/my-app/my-mission-app.py /home/kubos/my-mission-app.py
...
Next, we'll request that the OBC send us the application debug log file::
    ...
    $ kubos-file-client -r 10.0.2.20 -p 8070 -P 8081 download /var/log/app-debug.log
