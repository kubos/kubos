 ...
 *
 * Every 200ms, the CSP client thread pings the CSP server’s address to see if it is available,
 * and then connects and sends a CSP packet containing the message “Hello World”.
 *
