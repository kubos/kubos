...
extern "C" {
	...
	pub fn k_eps_set_input_value(in1_voltage:u16,in2_voltage:u16,in3_voltage:u16) -> KEPSStatus;
    ...
    pub fn k_eps_watchdog_start(interval:u32) -> KEPSStatus;
	pub fn k_eps_watchdog_stop() -> KEPSStatus;
